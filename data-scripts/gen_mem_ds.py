...
from aicsfeature.extractor import mem
...
for cid in tqdm(range(df_meta.shape[0])):
    ...
    tablef = tablef.append(mem.GetFeatures(None,seg=RAW[1,:,:,:]*SEG[1,:,:,:]), ignore_index=True)

#
# Save as pickle
#

with open('tmp_mem_drug_ds.pkl', 'wb') as fp:
